...
void MPU6050_WriteReg(uint8_t reg_add , uint8_t reg_dat) {
    ...
    HAL_I2C_Mem_Write(&I2C_MPU6050 , MPU6050_WRITE , reg_add , I2C_MEMADD_SIZE_8BIT ,
        &reg_dat , 1 , 0x1f);
    }
...
void MPU6050_ReadData(uint8_t reg_add , uint8_t* Read , uint8_t num) {
    ...
    HAL_I2C_Mem_Read(&I2C_MPU6050 , MPU6050_READ , reg_add , I2C_MEMADD_SIZE_8BIT ,
        Read , num , 0xff);
    }
